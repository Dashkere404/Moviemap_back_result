...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://floppy-tables-find.loca.lt/", "http://localhost:5173", "https://moviemap-inky.vercel.app/main"], 
...
movies_ft = pd.read_csv("movies_ft.csv")
movies_ft["vector"] = movies_ft["vector"].apply(lambda x: np.array(ast.literal_eval(x)))
movies_ft.set_index("movieId", inplace=True)
